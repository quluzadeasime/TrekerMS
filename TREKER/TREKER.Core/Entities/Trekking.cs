...
namespace TREKER.Core.Entities
{
    public class Trekking : BaseAuditableEntity
    {
        ...
        public ICollection<TrekkingFeature> Features { get; set; }
        public ICollection<TrekkingFacility> Facilities { get; set; }
        public ICollection<TrekkingImage> Images { get; set; }
    }
}
